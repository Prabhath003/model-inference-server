...
class TextGenerationBnbWorker(Worker):
                ...
                if selected_batch:
                    ...
                    try:
                        ...
                        for uuid, entry in selected_batch:
                            messages: List[Dict[str, str]] | List[List[Dict[str, str]]] = entry["payload"]["messages"]
                        ...
                        with torch.no_grad():
                            responses = pipe(input_texts, temperature=temperature, max_new_tokens=max_new_tokens)
                        ...
                        for uuid, entry, count in response_counts:
                            ...
                            final_response: str|List[str] = generated_texts if count > 1 else generated_texts[0]
